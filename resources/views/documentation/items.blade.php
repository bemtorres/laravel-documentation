...
<body class="docs-page">    
        ...
        <div class="branding docs-branding">
            <div class="container-fluid position-relative py-2">
                <div class="docs-logo-wrapper">
	                ...
	                <div class="site-logo"><a class="navbar-brand" href="index.html"><img class="logo-icon mr-2" src="/documentation/assets/images/coderdocs-logo.svg" alt="logo"><span class="logo-text">Coder<span class="text-alt">Docs</span></span></a></div>    
  ...
  },
  {
    ...
    <span class="hljs-attr">"description"</span>: {<span class="hljs-attr">"text"</span>: <span class="hljs-string">"..."</span>, <span class="hljs-attr">"sensitive"</span>: <span class="hljs-literal">false</span>}
					...
					<section class="docs-section" id="item-1-2">
						...
						<figure class="figure docs-figure py-3">
						    <a href="/documentation/assets/images/features/appify-theme-projects-overview-lg.jpg" data-title="Image Lightbox Example" data-toggle="lightbox"><img class="figure-img img-fluid shadow rounded" src="/documentation/assets/images/features/appify-add-members.gif" alt="" style="width: 600px;"></a>
    ...
    <!-- Javascript -->          
    <script src="/documentation/assets/plugins/jquery-3.4.1.min.js"></script>
    <script src="/documentation/assets/plugins/popper.min.js"></script>
    <script src="/documentation/assets/plugins/bootstrap/js/bootstrap.min.js"></script>  
    
    
    <!-- Page Specific JS -->
    <script src="https://cdnjs.cloudflare.com/ajax/libs/highlight.js/9.15.8/highlight.min.js"></script>
    <script src="/documentation/assets/js/highlight-custom.js"></script> 
    <script src="/documentation/assets/plugins/jquery.scrollTo.min.js"></script>
    <script src="/documentation/assets/plugins/lightbox/dist/ekko-lightbox.min.js"></script> 
    <script src="/documentation/assets/js/docs.js"></script> 
